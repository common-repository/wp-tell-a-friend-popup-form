...
function TellAFriend_widget_init()
{
	...
	{
		wp_register_sidebar_widget( 'wp-tell-a-friend-popup-form', __('Tell A Friend', 'wp-tell-a-friend-popup-form'), 'TellAFriend_widget');
	}
	
	if(function_exists('wp_register_widget_control')) 
	{
		wp_register_widget_control( 'wp-tell-a-friend-popup-form', array( __('Tell A Friend', 'wp-tell-a-friend-popup-form'), 'widgets'), 'TellAFriend_control');
	} 
}
